const PricingBlock = ({
    ...
    return (
        <div
            className={`rounded-lg overflow-hidden shadow-lg max-w-sm mx-auto h-full flex flex-col ${className}`}
        >
            ...
            {/* Features section */}
            <div className='bg-gray-200 px-6 py-8 flex-1 flex flex-col'>
